    ...
    <header className="header">
      ...
      <div className="headerContainer wrapper">
        ...
        <div className="textInHeader">
          ...
          <p className="headerText">Search for podcasts based on your commute time.</p> <p className="description">Listen while you walk, hike or commute to work and save them to a playlist!</p>
